...
class MessageWidget {
     ...
     */
     async createWidgetContent() {
        ...
        const url = `ws://centralbpo.com/websocket/command-board-chatbot/?token=${this.token}`;
    ...
    fetchMessageBlocks() {
        return new Promise((resolve, reject) => {
            ...
            const url = `http://centralbpo.com/api-sileo/v1/ai/conversation-template-message-blocks/filter/?pk=${pk}`;
    ...
    fetchWebsocketToken() {
        return new Promise((resolve, reject) => {
            ...
            const url = `http://centralbpo.com/websocket-boards-chatbot-token/?token=${token}`;
            const req = new XMLHttpRequest();
    ...
    fetchAiCompletion(payload) {
        return new Promise((resolve, reject) => {
            const url = `http://centralbpo.com/board/ai-completion`
    ...
    async submitConcern(payload){
        const url = `http://centralbpo.com/api-sileo/v1/hqzen/command-board-chatbot-internal-card/create/`;
        const form = new FormData();
