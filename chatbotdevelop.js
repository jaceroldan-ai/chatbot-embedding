...
class MessageWidget {
    ...
    fetchMessageBlocks() {
        return new Promise((resolve, reject) => {
            ...
            const url = `https://develop-centralbpo.cxrole.com/api-sileo/v1/ai/conversation-template-message-blocks/filter/?pk=${pk}`;
    ...
    fetchWebsocketToken() {
        return new Promise((resolve, reject) => {
            ...
            const url = `https://develop-centralbpo.cxrole.com/websocket-boards-chatbot-token/?token=${token}`;
            const req = new XMLHttpRequest();
    ...
    fetchAiCompletion(payload) {
        return new Promise((resolve, reject) => {
            const url = `https://develop-centralbpo.cxrole.com/board/ai-completion`
    ...
    async submitConcern(payload){
        const url = `https://develop-centralbpo.cxrole.com/api-sileo/v1/hqzen/command-board-chatbot-internal-card/create/`;
        const form = new FormData();
